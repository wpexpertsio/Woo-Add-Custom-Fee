...
1. Type in the name "Woo Add Custom Fee" in Search Plugins box
2. Find the "Woo Add Custom Fee" Plugin you wish to install.
...
== Screenshots ==
1. Dashboard Settings for Woo Add Custom Fee Plugin.
